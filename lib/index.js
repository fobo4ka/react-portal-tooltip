...
var Card = function (_React$Component) {
	...
	function Card(props) {
		...
		_this.margin = _this.props.margin;
		_this.defaultArrowStyle = {
			color: '#fff',
		...
		_this.state = {
			...
			width: 0,
			height: 0,
			styles: _this.checkWindowPosition(_this.getGlobalStyle(props, false, 'opacity'), _this.getArrowStyle(props))
		};
		return _this;
	}
	...
	_createClass(Card, [{
		key: 'getGlobalStyle',
		value: function getGlobalStyle(props, hover, transition) {
			if (!props.parentEl) {
				return { display: 'none' };
			}
			...
			(0, _objectAssign2.default)(style, this.getStyle(props.position, props.arrow, props.portalParent, props.parentEl));
		...
		value: function getArrowStyle() {
			...
			var arrowStyle = (0, _objectAssign2.default)(this.defaultArrowStyle, props.style.arrowStyle);
			...
			var _props$style$arrowSty = props.style.arrowStyle,
		...
		key: 'getStyle',
		value: function getStyle(position, arrow, portalParent, parentEl) {
			var _this2 = this;
		...
		value: function render() {
			var isDisableCloseOnHover = this.props.isDisableCloseOnHover;
			var styles = this.state.styles;


			return _react2.default.createElement(
				'div',
				{ style: styles, onMouseEnter: isDisableCloseOnHover && this.handleMouseEnter.bind(this), onMouseLeave: isDisableCloseOnHover && this.handleMouseLeave.bind(this) },
...
Card.propTypes = {
	...
	isDisableCloseOnHover: _propTypes2.default.bool
};
Card.defaultProps = {
	active: false,
	position: 'right',
	...
	function ToolTip(props, context) {
		...
		if (_exenv.canUseDOM) {
			...
			_this4.handleOutClick = function (event) {
				...
				var selfClick = event.target === _this4.root || _this4.root && _this4.root.contains(event.target);
				var isOutClick = !selfClick && event.target !== parentEL && parentEL && !parentEL.contains(event.target);
				_this4.isInClick = !selfClick;

				var _this4$props = _this4.props,
				    closeFunc = _this4$props.closeFunc,
				    active = _this4$props.active,
				    isCloseOnOutClickFunc = _this4$props.isCloseOnOutClickFunc;

				if (isOutClick && typeof closeFunc === 'function' && _this4.root && _this4.root.hasChildNodes()) {
			...
			props.isCloseOnOutClick && document.addEventListener('click', _this4.handleOutClick, true);
		}
		return _this4;
	}
...
ToolTip.propTypes = {
	...
	fullWidth: _propTypes2.default.bool,
	margin: _propTypes2.default.number,
	isCloseOnOutClick: _propTypes2.default.bool,
	isCloseOnOutClickFunc: _propTypes2.default.func
};
